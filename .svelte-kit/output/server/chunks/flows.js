        ...
        docs: [
          {
            ...
            url: "https://learn.microsoft.com/dynamics365/supply-chain/sales-marketing/sales-quotations"
          },
          {
      ...
      },
      {
        ...
        docs: [
          ...
          },
          {
            ...
            url: "https://learn.microsoft.com/dynamics365/supply-chain/sales-marketing/sales-orders-overview"
          }
        ],
        pitfalls: [
        ...
        docs: [
          {
            ...
            url: "https://learn.microsoft.com/dynamics365/supply-chain/accounts-receivable/configure-customer-invoices"
          },
          {
        ...
        docs: [
          {
            ...
            url: "https://learn.microsoft.com/dynamics365/finance/accounts-receivable/customer-payment-overview"
          },
          {
  ...
  },
  {
    ...
    stages: [
        ...
        docs: [
          {
            ...
            url: "https://learn.microsoft.com/dynamics365/fin-ops-core/fin-ops/organization-administration/overview-workflow-system"
          }
        ],
      ...
      },
      {
        ...
        docs: [
          {
            title: "Business process modeler (BPM)",
            url: "https://learn.microsoft.com/dynamics365/fin-ops-core/dev-itpro/lifecycle-services/bpm-overview"
          }
        ],
      ...
      },
      {
        ...
        docs: [
          {
            title: "Task recorder",
            url: "https://learn.microsoft.com/dynamics365/fin-ops-core/fin-ops/user-interface/task-recorder"
          }
        ],
  ...
  },
  {
    ...
    stages: [
        ...
        docs: [
          {
            ...
            url: "https://learn.microsoft.com/dynamics365/supply-chain/supply-chain-dev/process-guide-framework"
          }
        ],
      ...
      },
      {
        ...
        docs: [
          {
            title: "Cost management home",
            url: "https://learn.microsoft.com/dynamics365/supply-chain/cost-management/cost-management-home-page"
          }
        ],
  ...
  },
  {
    ...
    stages: [
      ...
      },
      {
        ...
        docs: [
          {
            title: "Glossary and process links",
            url: "https://learn.microsoft.com/dynamics365/supply-chain/cost-management/cost-management-home-page"
          }
        ],
  ...
  },
  {
    ...
    stages: [
      ...
      },
      {
        ...
        relations: [
          { from: "LedgerJournalTrans", to: "LedgerJournalTable", note: "Lines tied to journal header" },
          {
            from: "LedgerJournalTrans",
            to: "LedgerTrans",
    ...
    stages: [
      {
        ...
        docs: [
          {
            title: "HR business events overview",
            url: "https://learn.microsoft.com/dynamics365/fin-ops-core/fin-ops/hr/business-events-overview"
          }
        ],
    ...
    stages: [
      {
        ...
        docs: [
          {
            ...
            url: "https://learn.microsoft.com/dynamics365/supply-chain/service-management/fulfill-service-agreements-overview"
          }
        ],
        ...
        relations: [
          { from: "SMAAgreementLine", to: "CustTable", note: "Agreement tied to customer" },
          {
      ...
      },
      {
        ...
        docs: [
          {
            title: "Customer service business process",
            url: "https://learn.microsoft.com/dynamics365/supply-chain/service-management/working-with-customer-service"
          }
        ],
...
const tableDefs = {
  CustTable: {
    ...
    docsUrl: "https://learn.microsoft.com/en-us/common-data-model/schema/core/operationscommon/tables/finance/accountsreceivable/main/custtable",
    fields: [
      {
        name: "AccountNum",
        type: "String",
  ...
  InventDim: {
    ...
    docsUrl: "https://learn.microsoft.com/en-us/common-data-model/schema/core/operationscommon/tables/supplychain/inventory/group/inventdim",
    fields: [
      {
        name: "InventDimId",
        type: "String",
  ...
  CustSettlement: {
    ...
    module: "Accounts Receivable",
    docsUrl: "https://learn.microsoft.com/en-us/common-data-model/schema/core/operationscommon/tables/finance/accountsreceivable/transaction/custsettlement",
    fields: [
      {
        name: "RecId",
        type: "Int64",
